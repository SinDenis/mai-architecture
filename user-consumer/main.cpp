...
#include "../user-service/user.h"
#include "../user-service/user_storage.h"
...
int main() {
    try
    {
        ...
        cppkafka::Configuration config = {
                ...
                {"group.id", Config::get().queue_group_id()},
                // Disable auto commit
        ...
        consumer.subscribe({Config::get().queue_topic()});

        std::cout << "Consuming messages from topic " << Config::get().queue_topic() << std::endl;
